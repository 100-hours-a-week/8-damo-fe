...
ARG NEXT_PUBLIC_RECEIPT_WASM
ARG NEXT_PUBLIC_RECEIPT_MODEL
...
ENV NEXT_PUBLIC_RECEIPT_WASM=$NEXT_PUBLIC_RECEIPT_WASM
ENV NEXT_PUBLIC_RECEIPT_MODEL=$NEXT_PUBLIC_RECEIPT_MODEL
